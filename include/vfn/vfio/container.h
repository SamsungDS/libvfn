...
typedef struct vfio_container vfio_container_t;
 ...
 */
vfio_container_t *vfio_new(void);
 ...
 */
int vfio_map_vaddr(vfio_container_t *vfio, void *vaddr, size_t len, uint64_t *iova);
 ...
 * Return: ``0`` on success, ``-1`` on error and sets ``errno``.
 */
int vfio_unmap_vaddr(vfio_container_t *vfio, void *vaddr, size_t *len);
 ...
 * Return: ``0`` on success, ``-1`` on error and sets ``errno``.
 */
int vfio_map_vaddr_ephemeral(vfio_container_t *vfio, void *vaddr, size_t len, uint64_t *iova);
 ...
 * Return: ``0`` on success, ``-1`` on error and sets ``errno``.
 */
int vfio_unmap_ephemeral_iova(vfio_container_t *vfio, size_t len, uint64_t iova);
...
int vfio_get_iova_ranges(vfio_container_t *vfio, struct vfio_iova_range **ranges);
